...
//        when() requires an argument which has to be 'a method callWithNoArguments on a mock'.
//                For example:
...
//        2. inside when() you don't callWithNoArguments method on mock but on some other object.

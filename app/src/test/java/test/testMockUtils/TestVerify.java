...
public class TestVerify extends TestInit{
    ...
    public void test_callWithNoArgument() throws Exception {
        ...
        callOrigin.callVoid();
        UncleMock.verify(callOrigin,1).callWithNoArgument("callVoid");
    }
    ...
    public void test() throws Exception {
        ...
        UncleMock.verify(callOrigin,1).call("callTwo").withArguments("1","2");
    }
    ...
    public void testStatic() throws Exception {
        ...
        UncleMock.verify(StaticClass.class,1).call("getRealValue").withArguments(Mockito.anyInt(),Mockito.anyInt());
    }
    @Test
    public void testStatic_noArgument() throws Exception {
        UncleMock.mockStatic(StaticClass.class);
        StaticClass.getMockValue();
        UncleMock.verify(StaticClass.class,1).callWithNoArgument("getMockValue");
    }
